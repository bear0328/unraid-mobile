...
const CONTAINERS_RULES = [
  ...
  ['moviepilot_full-postgresql-1', 'postgres-18'],
  ['moviepilot_full-moviepilot-1', 'homeassistant'],
  ['article-article-1', 'wordpress'],
  ['article-postgres-1', 'postgres-15'],
  ['moviepilot-pgloader', 'pgloader'],
  ['envyafish/immortal:latest', 'wordpress:latest'],
  ['dimitri/pgloader:latest', 'pgloader:latest'],
