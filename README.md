...
Image tags: `latest` (newest stable) / `1.1.0` (pinned version). linux/amd64 only (unRAID platform).
...
curl -fsSL -o install-compose-api.sh \
  https://raw.githubusercontent.com/bear0328/unraid-mobile/v1.1.0/compose-api/install-compose-api.sh
curl -fsSL -o api.php \
  https://raw.githubusercontent.com/bear0328/unraid-mobile/v1.1.0/compose-api/api.php
