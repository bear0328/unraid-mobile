...
Image tags: `latest` (newest stable) / `1.0.7` (pinned version). linux/amd64 only (unRAID platform).
...
curl -fsSL -o install-compose-api.sh \
  https://raw.githubusercontent.com/bear0328/unraid-mobile/v1.0.7/compose-api/install-compose-api.sh
curl -fsSL -o api.php \
  https://raw.githubusercontent.com/bear0328/unraid-mobile/v1.0.7/compose-api/api.php
